        ...
        <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
          <div className="flex flex-col items-center justify-center lg:flex-row">
            <div className="rounded-full border-8 border-primary shadow-xl">
              <img src={builder.image(profile.image).width(200).url()} className="h-56 rounded-full sm:h-60" alt="author" />
            </div>
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                <div className="flex items-center justify-center pl-0 sm:justify-start md:pl-1">
                  <p className="font-body text-lg uppercase text-white">Developer | Coder | Software Geek</p>
        ...
        <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
          <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
            ...
            <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
              I am {profile.name}, a Web Developer & Teacher
            </h4>
            <p className="pt-6 font-body leading-relaxed text-grey-20">
              I had done my graduation from Government College University, Lahore. I had worked in Lahore Garrison Education System as IT Coordinator and Computer Science Teacher. I have a passion to work as a Web Developer. I have experience in developing and designing, web and desktop apps and responsive websites. I have 3+ years of experience in Full-Stack Web development and optimization. I can create a professional website and web app from scratch by using React js, Node js, express js, and MongoDB/Mysql/Sanity.
          ...
          <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
            ...
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">MERN</h4>
            ...
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">Sanity/Shopify</h4>
        ...
        <div className="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                Canva,Adobe Photoshop and Gravit Designer
              </p>
            </div>
          </div>
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      ...
      <div className="container py-16 md:py-20" id="portfolio">
        ...
        <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
          <div className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/shop1.PNG" className="w-full shadow" alt="portfolio image" />
          </div>
          <div className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/shop34.PNG" className="w-full shadow" alt="portfolio image" />
          </div>
          <div className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/shop99.PNG" className="w-full shadow" alt="portfolio image" />
          </div>
          <div className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/react4.PNG" className="w-full shadow" alt="portfolio image" />
          </div>
        </div>
      </div>
          ...
          <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
            ...
            {blogs.map((item) => {
              return <Link key={item.slug.current} href={"/blog/" + item.slug.current} className="shadow">
                <div key={item}><div style={{ "backgroundImage": `url(${builder.image(item.blogimage).width(200).url() || '/assets/img/post-01.png'})` }}
        ...
        <div className="container relative z-30">
          ...
          <div className="container flex flex-col justify-between py-6 sm:flex-row">
            <p className="text-center font-body text-white md:text-left">
              © Copyright 2022. All right reserved, Anosha Javed.
            </p>
